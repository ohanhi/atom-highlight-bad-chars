...
export default {
  ...
  confusables: {
    ...
    description:
      "Characters that can be confused with standard chars. There should be a reason why they happen: autoreplacements or they are used somewhere. For example figure dash `‒` vs. hyphen `-`.",
    type: "boolean",
    default: true
  },
  controlCharacters: {
