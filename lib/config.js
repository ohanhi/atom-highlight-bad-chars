...
export default {
  ...
  confusables: {
    ...
    description:
      "Characters that can be confused as some others that are commonly used in programming. For example semicolon `;` vs. Greek question mark `;` and less than `<` vs. left arrowhead `˂`.",
    type: "boolean",
    default: true
  },
  controlCharacters: {
